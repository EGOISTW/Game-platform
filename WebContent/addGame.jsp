		...
		<div class="top">
			...
			<div class="page_left">
				<div class="page_login">
					...
					<form action="${pageContext.request.contextPath}/item/addGame" method="post">
						...
						<div class="password">
							...
							<input type="text" name="gContext">
						</div>
						<div class="real_name">
							<p>出版商</p>
						
							<input type="text" name="gPublisher">
						</div>
						<div class="email" >
							<p>图片地址</p>
						
							<input type="text" name="gPhoto">
						</div>
						<div class="email">
							<p>发行日期</p>
						
							<input type="text" name="publishDate" onclick="selectDate(this,'yyyy-MM-dd hh:mm:ss')">
						</div>
						<div class="email">
							<p>发行价格</p>
